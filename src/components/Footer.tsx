...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-secondary border-t border-divider mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-brand-primary to-brand-primary-dark rounded-lg flex items-center justify-center text-white font-bold text-sm">
                Q
              </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-secondary">
              <li className="hover:text-brand-primary transition-colors">Live Q&A</li>
              <li className="hover:text-brand-primary transition-colors">Real-time Updates</li>
              <li className="hover:text-brand-primary transition-colors">Moderator Dashboard</li>
              <li className="hover:text-brand-primary transition-colors">Stage Display</li>
            </ul>
          </div>
